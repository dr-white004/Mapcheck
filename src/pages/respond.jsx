...
import Respquote from '../component/respquote';
  ...
  return (
    <main className="h-screen flex flex-col ">
      ...
      <div className="flex flex-grow">
        ...
        <div className="w-auto sm:w-auto md:w-auto h-full p-4 bg-[#F7F9FC] border-r border-gray-300 flex flex-col justify-start">
